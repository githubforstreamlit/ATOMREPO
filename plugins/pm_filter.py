...
async def next_page(bot, query):
    ...
    files, n_offset, total = await get_search_results(query.message.chat.id, search, offset=offset, filter=False)
    try:
    ...
    if query.data.startswith("file"):
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              ...
                              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/movies_1782")
                             ]
                            ]
                        )
                    )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/movies_1782")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
